import re
def check_resolving_power_All(resolving_power,info,medium):
    ...
    def check_resolving_power():
        ...
        if resolving_power=='SD':
            ...
            resolving_power9_2=re.search('640.*pixels|640.*像素',info)
            if resolving_power9 and resolving_power9_1:
                return True
            if resolving_power9_1 and resolving_power9_2:
                return True
