...
def check_code_All(code,info,medium,route,title):
    ...
    def check_code():
        ...
        if code=='H.264/AVC':
            ...
            code_type4_4=re.search('High@L4.1',info,re.I)
            if code_type4 or code_type4_1 or code_type4_2 or code_type4_3 or code_type4_4:
                return True
        if code=='H.265/HEVC':
            code_type6=re.search('HEVC',info)
            if code_type6:
        ...
        if code=='x264' or code=='x265':
            ...
            code_type7=re.search(code,info)
            code_type_ = re.search ('WEBRip', title, re.I)
            if code_type_ or code_type7 or code_type8 :
                return True
